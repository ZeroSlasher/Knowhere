...
<!-- Mirrored from preview.uideck.com/items/Knowhere-1.1/account-profile-setting.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2019 06:15:18 GMT -->
        ...
        <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main-navbar">
                    ...
                    <ul class="sign-in">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"><i class="lni-user"></i>
                                My Account</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item active" href="account-profile-setting.html"><i
                                        class="lni-home"></i>
                                    Account Home</a>
                                ...
                                <a class="dropdown-item" href="account-archived-ads.html"><i class="lni-folder"></i>
                                    Archived</a>
                                <a class="dropdown-item" href="login.html"><i class="lni-lock"></i>
                                    Log In</a>
                                <a class="dropdown-item" href="signup.html"><i class="lni-user"></i>
                                    Signup</a>
                                <a class="dropdown-item" href="forgot-password.html"><i class="lni-reload"></i> Forgot
                                    Password</a>
                    ...
                    <a class="tg-btn" href="post-ads.html">
                        <i class="lni-bookmark-alt"></i> Post An Ad
                    </a>
                </div>
            </div>
            ...
            <ul class="mobile-menu">
                ...
                <li>
                    ...
                    <ul class="dropdown">
                        <li><a class="active" href="account-profile-setting.html"><i class="lni-home"></i> Account
                                Home</a></li>
                        ...
                        <li><a href="forgot-password.html"><i class="lni-reload"></i> Forgot
                                Password</a></li>
                        <li><a href="account-close.html"><i class="lni-close"></i>Account close</a>
                        </li>
                    </ul>
                </li>
            </ul>
                            ...
                            <div class="inner-box">
                                <div class="tg-contactdetail">
                                    ...
                                    <div class="dashboard-wrapper">
                                        ...
                                        <button class="btn btn-common" type="button">Post
                                            Ad</button>
                                    </div>
                                </div>
                            </div>
