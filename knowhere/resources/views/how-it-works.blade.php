...
<body>
    ...
    <div class="page-title" style="background-image: url('images/background02.jpg');">
        <div class="inner">
            <h2>How It Works</h2>
            <p>Discover how EXploreCity can you help you find everything you want.</p>
        </div> <!-- end .inner -->
    </div> <!-- end .page-title -->
    ...
    <div class="section boxed-section light">
        <div class="inner">
            <div class="container">
                <div class="box no-side-padding">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="services">
                                <img src="images/services-icon01.png" alt="icon" class="img-responsive center-block">
                                <h3>Choose<br>What To Do</h3>
                                <p>Looking for a cozy hotel to stay, a restaurant to eat, a museum to visit or a mall to
                                    do some shopping?</p>
    ...
    <footer class="footer">
        <div class="top">
            ...
            <div class="right"></div> <!-- end .left -->
        </div> <!-- end .top -->
        <div class="bottom">Copyright &copy; 2019. All Rights Reserved By ZeroSlasher</div>
    </footer> <!-- end .footer -->
...
<!-- Mirrored from explorecity.icookcode.net/demo/how-it-works.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2019 04:41:30 GMT -->
