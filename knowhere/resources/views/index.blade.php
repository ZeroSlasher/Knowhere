...
<!-- Mirrored from explorecity.icookcode.net/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Mar 2019 04:41:30 GMT -->
<head>
		...
		<div class="login-wrapper">
			<div class="login">
				...
				@csrf
					...
					<div class="form-group">
					<input type="password" required placeholder="Password" id="password" name="password" onmouseover="this.type='text'" onmouseup="this.type='password'" onmouseout="this.type='password'" >
					</div> <!-- end .form-group -->
					<!-- <div class="right">
		...
		<div class="signup-wrapper">
			<div class="signup">
				...
				<center><p id="head" style="display: none;">All details are mandatory</p></center>
					...
					<div class="form-group">
					<input type="password"  placeholder="Password" id="pwd" name="pwd" onmouseover="this.type='text'" onmouseup="this.type='password'" onmouseout="this.type='password'" >
					</div> 
		...
		<div class="listing-wrapper">
			<div class="listing">
				...
				<div class="form-group1">
					...
					<div class="button-wrapper verify-open"><button type="submit" name="submit" class="button">Request verification</button></div>
					</div> 
					<div class="text-center">
