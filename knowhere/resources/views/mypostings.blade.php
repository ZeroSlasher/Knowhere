...
width:100%">
                                                    ...
                                                    <div class="feature-content">
                                                        ...
                                                        <div class="listing-bottom">
                                                            @if($own->status == 5)
                                                            <h3 class="btn-verified price float-left"><i class="lni-pointer-right"></i>Verified</h3>
                                                            @else
                                                            <h3 class="btn-verified price float-left"><i class="lni-pointer-right"></i>Referred</h3>
                                                            @endif
                                                            <a href="deletepost/{{$own->outletid}}" class="btn-verified float-right"><i class="lni-trash"></i>
                                                        Delete posting</a>                                                            &nbsp;&nbsp; &nbsp;

                                                            <a href="editpost/{{$own->outletid}}" class="btn-verified float-right"><i class="lni-pencil"></i>
                                                        Edit posting</a>&nbsp;&nbsp;
                                                            &nbsp;
